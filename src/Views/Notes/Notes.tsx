...
// import { customStyles } from '../../Components/Layouts/Private/customStyle';
...
//   const { label } = useParams();
//   const finalLabel = label || 'Others';
//   const { searchText } = useOutletContext<any>();
...
//         updateNote(uid, label, itemID, itemTitle, itemDesc);
//       } else {
//         saveNoteLabel(uid, finalLabel, itemTitle, itemDesc);
//         updateCollectionCount(uid, finalLabel, CONSTANTS.INCREMENT);
//       }
